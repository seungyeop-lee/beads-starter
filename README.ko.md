...
> 적용하는 두 가지 방식: 항시 발동 bash 설치형, 그리고 Claude Code · Codex에서
> 쓰는 플러그인 기반 명시적 발동 skill 묶음.
>
...
| 배포 채널 | `curl | bash` | Claude Code 및 Codex 플러그인 marketplace |
| 에이전트 호환성 | `AGENTS.md`를 읽는 모든 에이전트 (Claude Code, Cursor, Codex, …) | Claude Code, Codex |
